...
class BarGraph: UIView {
    ...
    private let presenter = BarGraphPresenter(barWidth: 40, space: 20)
    ...
    private func showEntry(index: Int, entry: BasicBarEntry, animated: Bool, oldEntry: BasicBarEntry?) {
        ...
        mainLayer.addTextLayer(frame: entry.bottomTitleFrame, color:  UIColor(red: 70/256, green: 56/256, blue: 83/256, alpha: 1.0).cgColor, fontSize: 14, text: entry.data.title, animated: animated, oldFrame: oldEntry?.bottomTitleFrame)
    }
